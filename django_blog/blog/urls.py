...
from .views import register,posts_by_tag, post_search, UserLoginView, profile, home, PostDetail, PostList, PostCreate, PostUpdate, PostDelete, CommentCreateView, CommentDeleteView, CommentUpdateView
